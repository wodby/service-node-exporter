# Node exporter service for Wodby

Use Node exporter as a reusable component in applications managed by Wodby. This
repository contains the service manifests and referenced files used by the
public Node exporter service in the Wodby catalog.

- [Node exporter service in the Wodby catalog](https://wodby.com/services/node-exporter)
...
4. Reference `node-exporter` from your stack manifest.
